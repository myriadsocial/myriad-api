...
import {Experience, UserExperience, UserExperienceRelations, User} from '../models';
...
> {
  ...
  public readonly user: BelongsToAccessor<User, typeof UserExperience.prototype.id>;
