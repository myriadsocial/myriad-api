...
import {Transaction, TransactionRelations, User, Token} from '../models';
...
> {
  ...
  constructor(
    ...
    protected userRepositoryGetter: Getter<UserRepository>, @repository.getter('TokenRepository') protected tokenRepositoryGetter: Getter<TokenRepository>,
  ) {
